        ...
        if (strlen($user_name) > 0 && (strlen($email) > 0 && filter_var($email, FILTER_VALIDATE_EMAIL)) && strlen($password) >= 0 && strlen($confirmPassword) >= 0) {
            ...
            if ($password == $confirmPassword ) {
                ...
                if(!empty($row)){
                    ...
                    $query= sprintf("INSERT INTO users (user_name,email,password,created_at) VALUES ('%s','%s','%s',Now())",
...
<?php require("navbar.php"); ?>
    ...
    <div class="container" style=" margin-top: 2%; width: 500px;border: ridge 1.5px white;padding: 30px;background-color: #f5f5f5;">
